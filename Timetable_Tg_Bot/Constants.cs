...
public class Constants
{
    ...
    public const string ChooseIsBusyTimeTable = @"^TCD_(.{2})_(.{2})_(.{1,2})_(.{1,2})_(.{4})$"; // minute_hour_day_month_year
    public const string IsBusyTimeTable = "TIB_(.)_(.{2})_(.{2})_(.{1,2})_(.{1,2})_(.{4})$";// true\false_minute_hour_day_month_year
